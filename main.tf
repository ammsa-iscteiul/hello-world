...
locals {
  resource_group_name    = "${var.resource_group_name_prefix}-${random_integer.sa_num.result}"
  service_principal_name = "${var.resource_group_name_prefix}-${random_integer.sa_num.result}"
}
